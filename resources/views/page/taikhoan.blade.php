...
<script>
     $(function () {
      ...
      $(("#accountFormEdit")).submit(function (e) {
        ...
        function edit(id)
                {
                $.get("/taikhoan/getbyid/"+id, /// day la ajac, lay du lieu ve tu duong dan va lay id
                    function (accounts) {  // tu return json controller du lieu dua ve  bien ten  accout hứng, kieu json
                        $("#id").val(accounts.id); // Dta ten bien #id la key id,accout
